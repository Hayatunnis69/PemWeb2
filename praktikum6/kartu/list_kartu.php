...
?>
    <div class="container">
      ...
      <a class="btn btn-success" href="list_pelanggan.php" role="button">Pelanggan</a>
      <a class="btn btn-success" href="list_kartu.php" role="button">Kartu</a>
      <a class="btn btn-success" href="list_vendor.php" role="button">Vendor</a>
